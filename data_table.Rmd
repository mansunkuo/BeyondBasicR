...
If you don' wrap a single column with list, 
...
This behavior is very convenient if yiu want to subset value with *i*
...
1. Create a vector called **pet_name** contains pets' name
